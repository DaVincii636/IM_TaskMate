    ...
    const STEPS = [
        {
            ...
            body:  'Hit this button to add a task. Set a name, dates, priority, category, and optional notes. You can also link it to a project or assign it to a teammate.',
            position: 'bottom',
        },
        {
            selector: 'a[href*="TM_Projects"], nav a[href*="Projects"]',
            fallback: 'nav, .navbar',
            title: 'Projects & Teams',
            body:  'Organise tasks under Projects, and group projects under Teams. Members of a project automatically see its tasks on their dashboard, calendar, and analytics.',
            position: 'bottom',
        },
        {
            ...
            fallback: 'nav, .navbar',
            title: 'Calendar View',
            body:  'See all your tasks — including ones assigned to you or shared via a project — laid out by date. Great for spotting busy stretches or upcoming deadlines.',
            position: 'bottom',
        },
        {
            ...
            fallback: 'nav, .navbar',
            title: 'Notifications',
            body:  'The bell alerts you to overdue tasks, upcoming deadlines, and when someone assigns a task to you or comments on one of your tasks.',
            position: 'bottom',
        },
        {
            ...
            fallback: 'nav, .navbar',
            title: 'Activity Feed',
            body:  'Track every change across your tasks, assigned tasks, and shared project tasks — edits, status changes, comments, and more.',
            position: 'bottom',
        },
        {
            ...
            fallback: 'nav, .navbar',
            title: 'Analytics',
            body:  'View your completion rate, average days to finish a task, missed deadlines by category, and weekly productivity trends — all reflecting your full workload.',
            position: 'bottom',
        },
    ];
